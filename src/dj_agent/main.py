...
_PREFILLED_STARTERS = [
    {
        ...
        "answer": (
            "## DIAGNOSE — AFC\n"
            "แกกำลังเป็น AFC (Average Frustrated Chump) — เอาเธอเป็นศูนย์กลาง กลัวเธอจะคิดว่าแกแย่ กลัวโดนปฏิเสธ focus ผิดที่แล้ว\n\n"
            "## NAME — ความกลัวที่ขายหน้าตัวเอง\n"
            "ความกลัวนี้ไม่ได้มาจากเธอ มันมาจากการที่แกวาง self-worth ไว้กับปฏิกิริยาของเธอ ทฤษฎีข้อ 26 บอกชัด: ความสุขของ DJ ขึ้นกับตัวเอง ไม่ใช่การกระทำของสาว\n\n"
            "## PRESCRIBE — ทำวันนี้เลย\n"
            "- ใช้ 3-Second Rule: เห็นแล้วเข้าไปภายใน 3 วินาที ห้ามคิดเยอะ\n"
            "- เปิดง่ายๆ ด้วย observation: \"เฮ้ สังเกตว่า...\" ไม่ต้องเพอร์เฟกต์\n"
            "- ยอมรับตั้งแต่แรกว่าอาจโดนปฏิเสธ แล้วเข้าไปคุยทั้งที่รู้ — นั่นแหละคือความกล้า\n\n"
            "## CHALLENGE\n"
            "ภายใน 48 ชั่วโมง เข้าไปคุยกับผู้หญิงที่ไม่รู้จัก 1 คน ไม่ต้องขอเบอร์ แค่เริ่มบทสนทนาให้ได้ แล้วกลับมารายงาน"
        ),
    },
    {
        "label": "FRIENDZONE",
